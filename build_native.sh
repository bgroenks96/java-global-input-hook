...
gcc -shared -m32 -o ./bin/lib$LIBKEYNAME-linux-i386.so $BIN/*.o -pthread -lX11
...
gcc -shared -m32 -o ./bin/lib$LIBMOUSENAME-linux-i386.so $BIN/*.o -pthread -lX11
...
gcc -shared -m64 -o ./bin/lib$LIBKEYNAME-linux-amd64.so $BIN/*.o -pthread -lX11
...
gcc -shared -m64 -o ./bin/lib$LIBMOUSENAME-linux-amd64.so $BIN/*.o -pthread -lX11
...
cp -f ./bin/libmousehook-linux-i386.so ./src/main/java/mousehook-linux-i386.lib
cp -f ./bin/libmousehook-linux-amd64.so ./src/main/java/mousehook-linux-amd64.lib
